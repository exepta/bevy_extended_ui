...
///
/// # Parameters
/// - `trigger`: A [`Trigger<Pointer<Click>>`] event generated by a user click.
...
///
/// # Parameters
/// - `trigger`: A [`Trigger<Pointer<Over>>`] when the pointer enters the checkbox area.
...
///
/// # Parameters
/// - `trigger`: A [`Trigger<Pointer<Out>>`] when the pointer leaves the checkbox area.
/// - `query`: Query for the UI widget state to be modified.
