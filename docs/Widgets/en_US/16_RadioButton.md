...
Single selection widget typically used within a FieldSet group.
...
- value carries the semantic selection value.
- selected marks the initially active entry.
- Typically managed in a fieldset.
